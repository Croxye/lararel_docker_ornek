        ...
        <x-bootstrap.card>
            ...
            <x-slot:body>
                @php
                    $actions = ['', ''];
                @endphp
                <x-bootstrap.table :parentClass="'table-responsive'" :parentElement="'div'" :class="'table table-bordered table-striped verticle-middle table-responsive-sm'" :headings="['Baslık1', 'Baslik2', 'Baslik3', 'action']"
                    :actions="$actions">
                    <x-slot name="columns">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($item->feature_status)
                                        <a href="javascript:void(0)" data-id="{{ $item->id }}"
                                            class="btn btn-success changeFeatureStatus">
                                            Active
                                        </a>
                                    @else
                                        <a href="javascript:void(0)" data-id="{{ $item->id }}"
                                            class="btn btn-danger changeFeatureStatus">
                                            Passive
                                        </a>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <span>
                                        <a href="javascript:void(0)" data-id="{{ $item->id }}" class="mr-4 editCategory"
                                            data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="fa fa-pencil color-muted"></i>
                                        </a>
                                        <a href="javascript:void(0)" data-id="{{ $item->id }}" class="deleteCategory"
